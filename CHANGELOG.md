...
- Made CycloneDX verification require a deterministic UUIDv5 `serialNumber` derived from application/repository/version/source commit, all 20 name/version pairs from the runtime hash lock, and the app release date metadata.
