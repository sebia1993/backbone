...
- Adds HTML report status shortcut buttons for `긴급`, `주의`, `정보`, and `변경없음`; the default report view shows only `긴급` and `주의`.
...
```text
backbone_state_tracker_v0.8.30_YYYYMMDD_windows_exe.zip
```
