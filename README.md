...
- Writes SHA256 checksum sidecars, a release manifest, `PACKAGE_INFO.txt`, and runs release ZIP content verification.
...
```text
backbone_state_tracker_v0.8.1_YYYYMMDD_windows_exe.zip
```
