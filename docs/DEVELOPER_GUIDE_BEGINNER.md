...
v0.8.52의 1단계 UI 현대화는 HPE Aruba AirWave 계열 운영 콘솔을 참고하되, 특정 제품 화면을 복제하지 않고 색감과 정보 계층만 반영합니다. v0.8.53은 같은 구조 안에서 주요 업무 화면의 안내 패널, 대상 요약, 선택 상태, 로그 가독성을 보강한 2단계 개선입니다.
