...
- 생성된 HTML 비교 리포트의 필터 영역을 문자열 포함 검사뿐 아니라 HTML 파서로 구조 검증하도록 테스트를 보강했습니다.
- 상태 카드, 상태별 바로가기, 비교 요약, 변경없음 요약, 명령별 상세 블록의 `data-*`, `hidden`, `aria-hidden` 속성을 확인합니다.
- HTML 리포트 런타임 동작, 수집, SSH, 비교 등급 판단 로직은 변경하지 않았습니다.
...
```text
dist\backbone_state_tracker_v0.8.38_20260614_source.zip
dist\backbone_state_tracker_v0.8.38_20260614_source.zip.sha256.txt
dist\backbone_state_tracker_v0.8.38_20260614_windows_exe.zip
dist\backbone_state_tracker_v0.8.38_20260614_windows_exe.zip.sha256.txt
dist\backbone_state_tracker_v0.8.38_20260614_release_manifest.txt
dist\backbone_state_tracker_v0.8.38_20260614_verify_release_package.ps1
```
