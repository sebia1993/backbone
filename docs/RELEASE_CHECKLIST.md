...
```text
backbone_state_tracker_v0.8.43_YYYYMMDD_source.zip
backbone_state_tracker_v0.8.43_YYYYMMDD_source.zip.sha256.txt
backbone_state_tracker_v0.8.43_YYYYMMDD_windows_exe.zip
backbone_state_tracker_v0.8.43_YYYYMMDD_windows_exe.zip.sha256.txt
backbone_state_tracker_v0.8.43_YYYYMMDD_release_manifest.txt
backbone_state_tracker_v0.8.43_YYYYMMDD_verify_release_package.ps1
```
